...
export const PersonalInformationHeader: React.FC<PersonalInformationHeaderProps> = (
  ...
  return (
    <header className="personal-info-header" style={{backgroundColor: '#292B2F'}}>
...
export const SearchBar: React.FC<{value: string, ChangeValue: (e: any) => void}> = (props) => {
...
export const ActivityContainer: React.FC<ActivityContainerProps> = (props) => {
  ...
  return (
    <article className='activity-container'>
      <button id='ac-btn-1' onClick={JoinTeamHandler}>Join Team</button>
      <button id='ac-btn-2' onClick={CreateTeamHandler}>Create Team</button>
    </article>
  )
}
